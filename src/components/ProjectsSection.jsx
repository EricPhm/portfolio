...
const projects = [
    {
        ...
        image: "../../projects/sunset-microsoft-5120x5120-13515.jpg",
        tags: ["React", "MySQL"],
        demoUrl: "#",
        githubUrl: "#",
    },
                            ...
                            <div className="p-6">
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {project.tags.map((tag) => (
                                        <span className="px-2 py-1 text-xs font-medium rounded-full bg-primary/20 bg-secondary text-secondary-foreground">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
